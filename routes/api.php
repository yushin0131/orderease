...
use App\Http\Controllers\OrderRemoveController;
...
Route::resource("orderget",OrderGetController::class);
Route::resource("orderremove",OrderRemoveController::class);
Route::resource("ordercheckout",OrderCheckOutController::class);